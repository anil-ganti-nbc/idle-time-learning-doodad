  ...
  "gpu-divergence": [
    {
      ...
      correctExplanation: "One warp issue slot, two passes, a mask. A shared PC is the pre-Volta encoding.",
    ...
    },
    {
      ...
      correctExplanation: "You cannot delete the branch; you can stop mixing both sides in one warp issue slot.",
      objectiveIds: ["Locate divergence inside one warp, not across warps"],
