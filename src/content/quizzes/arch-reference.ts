...
export const ARCH_REFERENCE_DRAFTS: Record<string, [QuizItemDraft, QuizItemDraft, QuizItemDraft]> = {
  "gpu-occupancy": [
    {
      ...
      objectiveIds: ["Define occupancy as a resource-limited warp count"],
    ...
    },
    {
      ...
      objectiveIds: ["Predict when occupancy stops helping"],
      prerequisiteConceptIds: ["gpu-warps", "gpu-exec-resources"],
      difficultyTier: 4,
    ...
    },
    {
      ...
      objectiveIds: ["Reason about the register/occupancy trade-off"],
  ...
  "gpu-divergence": [
    {
      ...
      objectiveIds: ["Locate divergence inside a warp"],
    ...
    },
    {
      ...
      objectiveIds: ["Diagnose the cost of a mixed if/else"],
    ...
    },
    {
      ...
      objectiveIds: ["Reason about layout versus divergence"],
  ...
  "gpu-scheduler": [
    ...
    },
    {
      ...
      objectiveIds: ["Diagnose a scheduler/cache interaction"],
    ...
    },
    {
      ...
      objectiveIds: ["Synthesize occupancy, divergence, and issue"],
