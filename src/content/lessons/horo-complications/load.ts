...
const LINKS = ["https://www.wostep.ch/index.php/en/training/chronometry-adjustments", "https://www.wostep.ch/index.php/en/training-and-education"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by WOSTEP chronometry/chronograph training; course prose not copied.`,
  };
}
