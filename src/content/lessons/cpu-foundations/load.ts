...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    generatedAt: extra?.generatedAt ?? "2026-08-19T00:00:00.000Z",
    links: extra?.links ?? LINKS,
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by MIT 6.823 and Stanford CS149; course prose not copied.`,
  };
}
