...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    generatedAt: extra?.generatedAt ?? "2026-08-19T18:00:00.000Z",
    links: extra?.links ?? LINKS,
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by Stanford CS149, the CUDA C++ Programming Guide, and MIT 6.823; course prose not copied.`,
  };
}
