...
const LINKS = ["https://hs-ny.org/nyc-education", "https://www.wostep.ch/index.php/en/training-and-education"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    generatedAt: extra?.generatedAt ?? "2026-08-20T07:00:00.000Z",
    links: extra?.links ?? LINKS,
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by HSNY and WOSTEP; course prose not copied.`,
  };
}
