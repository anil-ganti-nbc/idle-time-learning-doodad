...
const LINKS = ["https://cs229.stanford.edu/syllabus-new.html", "https://web.stanford.edu/class/cs224n/"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by Stanford CS229 and CS224N; course prose not copied.`,
  };
}
