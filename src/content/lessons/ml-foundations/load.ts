...
const LINKS = ["https://cs229.stanford.edu/syllabus-new.html"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by Stanford CS229; course prose not copied.`,
  };
}
