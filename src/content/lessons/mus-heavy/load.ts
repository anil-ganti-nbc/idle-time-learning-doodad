...
const LINKS = ["https://ocw.mit.edu/courses/21m-302-harmony-and-counterpoint-ii-spring-2005/pages/syllabus/", "https://ocw.mit.edu/courses/21m-350-musical-analysis-spring-2008/pages/syllabus/"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · informed by MIT 21M.302/350; course prose not copied.`,
  };
}
