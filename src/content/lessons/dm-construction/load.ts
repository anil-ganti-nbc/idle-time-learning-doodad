...
const LINKS = ["https://ocw.mit.edu/courses/res-21m-001-heavy-metal-101-january-iap-2025/", "https://online.berklee.edu/courses/metal-guitar"];
...
function provenance(courseId: string, moduleId: string, conceptId: string, extra?: Provenance): Provenance {
  return {
    ...
    notes:
      extra?.notes ??
      `${courseId} / ${moduleId} / ${conceptId} · curriculumVersion 1 · DAU construction heuristics. MIT Heavy Metal 101 and Berklee metal-guitar material are survey/technique background, not genre law. Course prose not copied.`,
  };
}
