...
import { $t as getCurrentAdapter, At as boolean, Bt as union, C as serializeSignedCookie, Ct as isSafeUrlScheme, D as decodeJwt, E as base64Url, Ft as object, It as optional, Jt as ATTR_HOOK_TYPE, Kt as withSpan, Lt as record, Mt as literal, Nt as looseObject, O as decodeProtectedHeader, Ot as any, Pt as number, Q as encode, Qt as getAuthTables, Rt as string, S as serializeCookie, Sn as defineErrorCodes, St as createFetch, Ut as capitalizeFirstLetter, Wt as toKebabCase, Xt as import_src, Yt as ATTR_OPERATION_ID, Zt as safeJSONParse, _ as runWithRequestState, _n as isTest, a as createAuthorizationURL, an as initGetFieldName, b as createRouter$1, bn as kAPIErrorHeaderSymbol, c as createRateLimitKey, cn as createLogger, d as deprecate, en as queueAfterTransactionHook, f as createAuthEndpoint, fn as env, g as hasRequestState, gn as isProduction, h as defineRequestState, hn as isDevelopment, i as refreshAccessToken, in as initGetModelName, jt as email, k as jwtVerify, kt as array, l as findInvalidTrustedProxies, ln as logger, m as isAPIError, n as socialProviders, nn as runWithTransaction, o as applyDefaultAccessTokenExpiry, on as generateId, p as createAuthMiddleware, qt as ATTR_CONTEXT, r as validateAuthorizationCode, rn as getBetterAuthVersion, s as isLoopbackHost, sn as createRandomStringGenerator, t as SocialProviderListEnum, tn as runWithAdapter, u as getIp, un as shouldPublishLog, ut as JWTExpired, v as getCurrentAuthContext, vn as APIError, w as filterOutputFields, wt as normalizePathname, x as toResponse, xn as BASE_ERROR_CODES, xt as betterFetch, y as runWithEndpointContext, yn as BetterAuthError } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BLJIBKSA.js
var router_BLJIBKSA_exports = /* @__PURE__ */ __exportAll({
	a: () => Route$6,
	c: () => GROK_PROVIDERS,
	getRouter: () => getRouter,
	i: () => Route$3,
...
function AppShell({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "grid size-7 place-items-center rounded-sm bg-raised shadow-[0_0_0_1px_rgba(255,255,255,0.1)]",
							"aria-hidden": true,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex items-center gap-2",
						children: isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-16 animate-pulse rounded-sm bg-raised" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignedOut, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/login",
			...
			className: "mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:py-12",
			children
		})]
	});
}
var styles_default = "/assets/styles-DrCZ25iA.css";
...
var $$splitComponentImporter$11 = () => import("./routes-c-AMTg6o.mjs");
var Route$12 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./graph-C5eTeBZY.mjs");
var Route$11 = createFileRoute("/graph")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./history-CxBJuXym.mjs");
var Route$10 = createFileRoute("/history")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./library-DaAwLllH.mjs");
var Route$9 = createFileRoute("/library")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./login-DfEZcldo.mjs");
var Route$8 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./reviews-Djn_Zwoj.mjs");
var Route$7 = createFileRoute("/reviews")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./session-DYYnaXo0.mjs");
var Route$6 = createFileRoute("/session")({
	validateSearch: (raw) => {
		const search = {};
...
var $$splitComponentImporter$4 = () => import("./settings-BTQhBdio.mjs");
var Route$5 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./topics-C0wOlN2d.mjs");
var Route$4 = createFileRoute("/topics")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./learn._lessonId-BbCOaa8a.mjs");
...
var $$splitComponentImporter$1 = () => import("./learn_._lessonId.quiz-CTBEmRB5.mjs");
var Route$1 = createFileRoute("/learn_/$lessonId/quiz")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./learn_._lessonId.rate-hS-Ee_ku.mjs");
...
var rootRouteChildren = {
	...
	GraphRoute: Route$11.update({
		id: "/graph",
		path: "/graph",
		getParentRoute: () => Route$13
	}),
	HistoryRoute: Route$10.update({
		id: "/history",
		path: "/history",
		getParentRoute: () => Route$13
	}),
	LibraryRoute: Route$9.update({
		id: "/library",
		path: "/library",
		getParentRoute: () => Route$13
	}),
...
//#endregion
export { Route$6 as a, signIn as c, Route$3 as i, Route as n, cn as o, Route$1 as r, router_BLJIBKSA_exports as s, GROK_PROVIDERS as t };
