...
import { $t as import_src, At as array, Bt as string, C as serializeSignedCookie, Cn as kAPIErrorHeaderSymbol, Ct as isSafeUrlScheme, D as decodeJwt, E as base64Url, Ft as number, Ht as union, It as object, Kt as capitalizeFirstLetter, Lt as optional, Mt as email, Nt as literal, O as decodeProtectedHeader, Pt as looseObject, Q as encode, Qt as ATTR_OPERATION_ID, Rt as record, S as serializeCookie, Sn as BetterAuthError, St as createFetch, Tn as defineErrorCodes, Xt as ATTR_CONTEXT, Yt as withSpan, Zt as ATTR_HOOK_TYPE, _ as runWithRequestState, a as createAuthorizationURL, an as runWithTransaction, b as createRouter$1, bn as isTest, c as createRateLimitKey, cn as initGetFieldName, d as deprecate, dn as createLogger, en as safeJSONParse, f as createAuthEndpoint, fn as logger, g as hasRequestState, h as defineRequestState, hn as env, i as refreshAccessToken, in as runWithAdapter, jt as boolean, k as jwtVerify, kt as any, l as findInvalidTrustedProxies, ln as generateId, m as isAPIError, n as socialProviders, nn as getCurrentAdapter, o as applyDefaultAccessTokenExpiry, on as getBetterAuthVersion, p as createAuthMiddleware, pn as shouldPublishLog, qt as toKebabCase, r as validateAuthorizationCode, rn as queueAfterTransactionHook, s as isLoopbackHost, sn as initGetModelName, t as SocialProviderListEnum, tn as getAuthTables, u as getIp, un as createRandomStringGenerator, ut as JWTExpired, v as getCurrentAuthContext, vn as isDevelopment, w as filterOutputFields, wn as BASE_ERROR_CODES, wt as normalizePathname, x as toResponse, xn as APIError, xt as betterFetch, y as runWithEndpointContext, yn as isProduction } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DocPpzdv.js
var router_DocPpzdv_exports = /* @__PURE__ */ __exportAll({
	a: () => Route$4,
	c: () => signIn,
	getRouter: () => getRouter,
	i: () => Route$3,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			user.profileImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "grid size-8 place-items-center rounded-full bg-raised text-xs font-medium text-fg",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "grid size-7 shrink-0 place-items-center rounded-sm bg-raised shadow-[0_0_0_1px_rgba(255,255,255,0.1)]",
							"aria-hidden": true,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "flex gap-0.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-3 w-0.5 rounded-full bg-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-3 w-0.5 rounded-full bg-primary" })]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "truncate font-display text-[15px] tracking-tight",
							children: "Dead Air University"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
						...
						children: NAV.map((item) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: item.to,
								className: cn("rounded-sm px-3 py-2 text-sm no-underline transition-colors duration-150", active ? "text-fg" : "text-muted hover:text-fg"),
								children: item.label
							}, item.to);
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/about",
							className: cn("hidden text-sm no-underline sm:inline", pathname === "/about" ? "text-fg" : "text-muted hover:text-fg"),
							children: "How it works"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignedIn, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserButton, {}) })]
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				className: "flex gap-1 overflow-x-auto border-t border-border/60 px-2 py-1 sm:hidden",
				children: [...NAV, {
					to: "/about",
					label: "About",
					exact: true
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: item.to,
						className: cn("min-h-10 shrink-0 rounded-sm px-3 py-2 text-sm no-underline", active ? "text-fg" : "text-muted"),
						children: item.label
					}, item.to);
				})
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
			className: "mx-auto w-full max-w-5xl flex-1 overflow-x-hidden px-4 py-8 sm:py-12",
			children
		})]
	});
}
var styles_default = "/assets/styles-D0eujcjK.css";
var APP_NAME = "Dead Air University";
var Route$15 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "I have X minutes. Teach me something. Micro-lessons for unpredictable gaps."
			},
			{
			...
			},
			{
				...
				content: "I have X minutes. Teach me something."
			},
			...[],
			...[]
		],
...
var $$splitComponentImporter$13 = () => import("./routes-DSEwvI_0.mjs");
var Route$14 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./about-NocV-6jE.mjs");
var Route$13 = createFileRoute("/about")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./graph-D-rLjJIB.mjs");
var Route$12 = createFileRoute("/graph")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./history-u6y99p9k.mjs");
var Route$11 = createFileRoute("/history")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./library-7UOfwYhL.mjs");
var Route$10 = createFileRoute("/library")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./login-MUqRXaSq.mjs");
var Route$9 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./reviews-ByS08110.mjs");
var Route$8 = createFileRoute("/reviews")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./session-BZ2rsZvA.mjs");
var Route$7 = createFileRoute("/session")({
	validateSearch: (raw) => {
		const search = {};
...
var $$splitComponentImporter$5 = () => import("./settings-BVv1T6Ov.mjs");
var Route$6 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./topics-CLukn9Qg.mjs");
var Route$5 = createFileRoute("/topics")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./course._courseId-CkSh92Lv.mjs");
var Route$4 = createFileRoute("/course/$courseId")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./learn._lessonId-iOsFdrVJ.mjs");
var Route$3 = createFileRoute("/learn/$lessonId")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
...
var $$splitComponentImporter$1 = () => import("./learn_._lessonId.quiz-DCgyOtd4.mjs");
var Route$1 = createFileRoute("/learn_/$lessonId/quiz")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./learn_._lessonId.rate-IDUatoud.mjs");
var Route = createFileRoute("/learn_/$lessonId/rate")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var rootRouteChildren = {
	...
	AboutRoute: Route$13.update({
		id: "/about",
		path: "/about",
		getParentRoute: () => Route$15
	}),
	GraphRoute: Route$12.update({
		id: "/graph",
		path: "/graph",
		getParentRoute: () => Route$15
	}),
	...
	ReviewsRoute: Route$8.update({
		id: "/reviews",
		path: "/reviews",
		getParentRoute: () => Route$15
	}),
	SessionRoute: Route$7.update({
		id: "/session",
		path: "/session",
		getParentRoute: () => Route$15
	}),
	SettingsRoute: Route$6.update({
		id: "/settings",
		path: "/settings",
		getParentRoute: () => Route$15
	}),
	...
	CourseCourseIdRoute: Route$4.update({
		id: "/course/$courseId",
		path: "/course/$courseId",
		getParentRoute: () => Route$15
	}),
	LearnLessonIdRoute: Route$3.update({
		id: "/learn/$lessonId",
		path: "/learn/$lessonId",
		getParentRoute: () => Route$15
	}),
	...
	LearnLessonIdQuizRoute: Route$1.update({
		id: "/learn_/$lessonId/quiz",
		path: "/learn/$lessonId/quiz",
		getParentRoute: () => Route$15
	}),
	LearnLessonIdRateRoute: Route.update({
...
//#endregion
export { Route$4 as a, router_DocPpzdv_exports as c, Route$3 as i, signIn as l, Route as n, Route$7 as o, Route$1 as r, cn as s, GROK_PROVIDERS as t };
