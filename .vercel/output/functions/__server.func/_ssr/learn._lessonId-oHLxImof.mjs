...
import { i as Route$3 } from "./router-Bg908uEK.mjs";
...
import { n as SourceBadge, t as ProvenanceLine } from "./provenance-psaqoQS3.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/learn._lessonId-oHLxImof.js
...
function deployedBaseForLab(labId) {
	if (typeof window === "undefined") return void 0;
	const url = window.__DAU_LAB_URLS__?.[labId];
...
function initPracticeResultListener(onResult) {
	...
	const overrides = typeof window !== "undefined" ? window.__DAU_LAB_URLS__ : void 0;
	for (const labId of labIds) for (const candidate of [getLab(labId)?.launchUrl, overrides?.[labId]]) {
